...
// $cas_server_ca_cert_path = 'ca-certificates.crt'; // V1
$cas_server_ca_cert_path = './../libcas/ca-certificates.crt';
...
$cas_real_hosts = array('cas.unicaen.fr');

// Client config for the required domain name, should be protocol, hostname and port
$client_service_name = 'https://dev-borneti231.users.info.unicaen.fr'; // placez votre chemin
