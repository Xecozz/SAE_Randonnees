<?php
	...
	$db_usernameOracle = "ETU1_4";
	$db_passwordOracle = "ETU1_4"; // 
	$dbOracle = "oci:dbname=harpagon.unicaen.fr:1521/info.harpagon.unicaen.fr;charset=AL32UTF8";  

	$db_usernameMySQL = "ETU1_4";
	$db_passwordMySQL = "ETU1_4"; //
	$dbMySQL = "mysql:host=localhost;dbname=TP2_PHP;charset=UTF8";
 ?>
