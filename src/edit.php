					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="mt-3">
									<h4>Prénom Nom</h4>
                                    <button class="btn btn-primary mt-4">Randonneur</button>
									<button class="btn btn-primary mt-4">Organisateur</button>
									<button class="btn btn-primary mt-4">Guide</button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="le nom">
								</div>
							</div>
                            <div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="le prénom">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="numéro">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="la ville">
								</div>
							</div>
							<div class="row">
								<div class="col-sm-3"></div>
								<div class="col-sm-9 text-secondary">
									<input type="button" class="btn btn-primary px-4" value="Sauvegarder">
                                    <a class="btn btn-outline-primary btn-rounded" href="profil.html" role="button">Annuler</a>
								</div>
							</div>
						</div>
					</div>
